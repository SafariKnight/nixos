...
declare module "gi://Json?version=1.0" {
  ...
  export namespace Json {
     ...
     */
    function construct_gobject<T = GObject.Object>(
      gtype: GObject.GType,
      data: string,
      length: number,
    ): T;
     ...
     */
    function gobject_deserialize<T = GObject.Object>(
      gtype: GObject.GType,
      node: Node,
    ): T;
    /**
     ...
     * @returns a new object instance of the given type
     */
    function gobject_from_data<T = GObject.Object>(
      gtype: GObject.GType,
      data: string,
      length: number,
    ): T;
    ...
    class Builder extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Builder.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Generator extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Generator.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Parser extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Parser.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "array-end",
        callback: (_source: this, array: Array) => void,
      ): number;
      connect_after(
        signal: "array-end",
        callback: (_source: this, array: Array) => void,
      ...
      connect(
        signal: "error",
        callback: (_source: this, error: any | null) => void,
      ): number;
      connect_after(
        signal: "error",
        callback: (_source: this, error: any | null) => void,
      ...
      connect(
        signal: "object-end",
        callback: (_source: this, object: Object) => void,
      ): number;
      connect_after(
        signal: "object-end",
        callback: (_source: this, object: Object) => void,
    ...
    class Reader extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Reader.ConstructorProps>,
        ...args: any[]
      );
