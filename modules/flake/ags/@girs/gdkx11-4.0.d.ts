...
declare module "gi://GdkX11?version=4.0" {
  ...
  export namespace GdkX11 {
    ...
    class X11Display extends Gdk.Display {
      ...
      connect(
        signal: "xevent",
        callback: (_source: this, xevent: any | null) => boolean,
      ): number;
      connect_after(
        signal: "xevent",
        callback: (_source: this, xevent: any | null) => boolean,
      ...
      string_to_compound_text(
        str: string,
      ): [number, string, number, Uint8Array];
      /**
    ...
    class X11Drag extends Gdk.Drag {
      ...
      constructor(
        properties?: Partial<X11Drag.ConstructorProps>,
        ...args: any[]
      );
    ...
    class X11Surface extends Gdk.Surface {
      ...
      constructor(
        properties?: Partial<X11Surface.ConstructorProps>,
        ...args: any[]
      );
