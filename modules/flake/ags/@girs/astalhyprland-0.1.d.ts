...
declare module "gi://AstalHyprland?version=0.1" {
  ...
  export namespace AstalHyprland {
    ...
    class Client extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Client.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "moved-to",
        callback: (_source: this, workspace: Workspace) => void,
      ): number;
      connect_after(
        signal: "moved-to",
        callback: (_source: this, workspace: Workspace) => void,
    ...
    class Hyprland extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Hyprland.ConstructorProps>,
        ...args: any[]
      );
      ...
      connect(
        signal: "event",
        callback: (_source: this, event: string, args: string) => void,
      ): number;
      connect_after(
        signal: "event",
        callback: (_source: this, event: string, args: string) => void,
      ...
      connect(
        signal: "urgent",
        callback: (_source: this, client: Client) => void,
      ): number;
      connect_after(
        signal: "urgent",
        callback: (_source: this, client: Client) => void,
      ...
      connect(
        ...
        callback: (_source: this, id: number) => void,
      ): number;
      connect_after(
        signal: "workspace-removed",
        callback: (_source: this, id: number) => void,
    ...
    class Position extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Position.ConstructorProps>,
        ...args: any[]
      );
    ...
    class Workspace extends GObject.Object {
      ...
      constructor(
        properties?: Partial<Workspace.ConstructorProps>,
        ...args: any[]
      );
